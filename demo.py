...
To run this program from the Linux terminal:
...
def randomColoredRectangle(p):
    ...
    Return value :: Rectangle
      ...
      high, centered at the point p and filled with a random color.
    '''
...
def main():
    ...
    w = GraphWin("Graphics " + graphics.__version__, 300, 300)
